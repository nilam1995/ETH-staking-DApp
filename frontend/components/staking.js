...
import { StakingABI, StakingAddress } from '../context/constants';
    ...
    <section className={styles.stakingContainer}>
      <section>
        <section className={styles.stakeUnstakeTab}>
          ...
          <section className={`${unstakingTab ? styles.stakingType : ""}`}
          id='unstake'
          ...
          {stakingTab ? (
            <section className={styles.stakingBox}>
              ...
              <section className={styles.stakingInfo}>
                <p>
                  Balance <span>{(walletBalance / 10 ** 10).toLocaleString()}</span>
                </p>
            ...
            <section className={styles.stakingBox}>
              ...
              <section className={styles.stakingInfo}>
                ...
                <p>You Receive: {unstakeValue == 0 ? "" : unstakeValue * 1.07}</p>
              </section>  
              <button 
                className={styles.stakeBtn}
